        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0"
            ...
            <div class="container-fluid d-flex flex-column p-0"><a
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar" style="color: rgb(0,0,0);">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="{{ url('/ajout-acte') }}"
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <section class="contact-clean" style="background: rgba(241,247,252,0);">
                    <form method="post" action="{{ route('enregistrer', ['modelName' => 'Acte']) }}">
                        @csrf
                        ...
                        @endif
                        <h2 class="text-center">Ajout de type d'acte</h2>
                        <div class="mb-3"><label class="form-label">Nom de l'acte</label><input
                    ...
                    <div class="container">
                        <div class="card shadow">
                            <div class="card-header py-3">
                                <p class="text-primary m-0 fw-bold">Acte Info</p>
                            </div>
                                    ...
                                    <table class="table my-0" id="dataTable">
                                        ...
                                        <tbody>
                                            @foreach ($acte as $actes)
                                                <tr>
                                                    <td>{{ $actes->nom }}</td>
                                                    <td>{{ number_format($actes->budgetannuel, 2, ',', ' ') }}Ar</td>
                                                    <td>{{ $actes->code }}</td>
                                                    <td style="text-align: left;">
                                                        <button class="btn btn-link" type="button"
                                                            style="border: none; color: blue; text-decoration: underline;"
                                                            data-bs-toggle="modal"
                                                            data-bs-target="#modification-modal-{{ $actes->id }}">
                                                            Modifier
                                                        </button>
                                                    </td>
                                                    <td style="text-align: left;">
                                                        <button class="btn btn-link" type="button"
                                                            ...
                                                            data-bs-toggle="modal"
                                                            data-bs-target="#suppression-modal-{{ $actes->id }}">
                                                            Supprimer
                                                        </button>
                                                    </td>
                                                </tr>
                                                ...
                                                <div class="modal fade" role="dialog" tabindex="-1"
                                                    id="modification-modal-{{ $actes->id }}">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content" style="background-color: white">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <form
                                                                    action="{{ route('modifier', ['modelName' => 'Acte', 'id' => $actes->id]) }}"
                                                                    method="post">
                                                                    @csrf
                                                                    @if (Session::has('success'))
                                                ...
                                                <div class="modal fade" role="dialog" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content" style="background-color: white">
                                                            ...
                                                            <div class="modal-body">
                                                                <form method="POST"
                                                                    action="{{ route('supprimer', ['modelName' => 'Acte', 'id' => $actes->id]) }}">
                                                                    @csrf
                                                                    @if (Session::has('success'))
                                                                        <div class="alert alert-success">
                                                                            {{ Session::get('success') }}</div>
