            ...
            <div class="container-fluid d-flex flex-column p-0"><a
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar" style="color: rgb(0,0,0);">
                    ...
                    <li class="nav-item"><a class="nav-link" href="profile.html" style="color: rgba(0,0,0,0.8);"><i
                                class="fas fa-user" style="color: rgba(0,0,0,0.3);"></i><span>Profile</span></a></li>
                    <li class="nav-item"><a class="nav-link active" href="table.html" style="color: rgba(0,0,0,0.8);"><i
                                class="fas fa-table" style="color: rgba(0,0,0,0.3);"></i><span>Table</span></a><a
                            class="nav-link active" href="table.html" style="color: rgba(0,0,0,0.8);"><i
                                class="fas fa-table" style="color: rgba(0,0,0,0.3);"></i><span>Insertion</span></a></li>
                    <li class="nav-item"><a class="nav-link" href="login.html" style="color: rgba(0,0,0,0.8);"><i
                                class="far fa-user-circle" style="color: rgba(0,0,0,0.3);"></i><span>Login</span></a>
                    </li>
                    <li class="nav-item"><a class="nav-link" href="register.html" style="color: rgba(0,0,0,0.8);"><i
                                class="fas fa-user-circle" style="color: rgba(0,0,0,0.3);"></i><span>Register</span></a>
                    </li>
                </ul>
